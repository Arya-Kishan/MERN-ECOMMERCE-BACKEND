...
exports.sendMail = async (email, subject, html) => {
  ...
  const info = await transporter.sendMail({
    from: '"Arya Ecommerce 👻" <foo@example.com>',
    to: email,
    subject: subject,
    text: "Hello world?",
    html: html,
  ...
  console.log("after info mail");
  return info;

}


exports.receiptHtml = async (order) => {

  const products = [];
  for (let itemId of order.itemId) {
    let product = await Product.findById(itemId, 'title price');
                ...
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      ...
                      <td align="left" bgcolor="#D2C7BA" width="25%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">#<strong>${order._id}</strong></td>
                    </tr>
                    ${products.map((product) => (
    `                    <tr>
                        <td align="left" width="75%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">${product.title}</td>
                        <td align="left" width="25%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><span>$</span>${product.price}</td>
                      </tr>`
  ))}
                    <tr>
                      ...
                      <td align="left" width="25%" style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong><span>$</span>${order.totalAmount}</strong></td>
                    </tr>
                  </table>
                </td>
              </tr>
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                      <tr>
                        <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                          ...
                          <p>${order.selectedAddresses.map((address) => (
